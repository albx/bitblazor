...
{
    /// <summary>
    /// Gets or sets the content to be rendered inside the toolbar. This can include one or more <see cref="BitToolbarItem"/> components.
    /// </summary>
    [Parameter]
    [EditorRequired]
    ...
    /// <summary>
    /// Gets or sets the size of the toolbar. This property allows you to specify the visual size of the toolbar, which can affect its layout and appearance. 
