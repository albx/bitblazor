...
```razor
<BitNumberField Label="Even Number Only" 
                @bind-Value="evenNumber"
                For="@(() => evenNumber)"
                AdditionalTextId="even-help">
    <AdditionalText>
...
@code {
    [CustomValidation(typeof(ValidationHelper), nameof(ValidationHelper.ValidateEvenNumber))]
    private int evenNumber;
    
    public static class ValidationHelper
    {
        public static ValidationResult ValidateEvenNumber(int value, ValidationContext context)
        {
            return value % 2 == 0 
...
<BitNumberField<int> Label="Quantity" @bind-Value="quantity" />
<BitNumberField<decimal> Label="Price" @bind-Value="price" />
<BitNumberField<double> Label="Percentage" @bind-Value="percentage" />

<!-- ❌ Bad: Using wrong types -->
<BitNumberField<string> Label="Age" @bind-Value="age" /> <!-- Won't compile -->
```

### 2. Set Reasonable Min/Max Values

```razor
<!-- ✅ Good: Logical constraints -->
<BitNumberField Label="Age" @bind-Value="age" Min="0" Max="120" />
<BitNumberField Label="Percentage" @bind-Value="percentage" Min="0" Max="100" />

<!-- ❌ Bad: No constraints where needed -->
<BitNumberField Label="Percentage" @bind-Value="percentage" />
```

### 3. Use Appropriate Step Values

```razor
<!-- ✅ Good: Meaningful steps -->
<BitNumberField Label="Price" @bind-Value="price" Step="0.01m" />
<BitNumberField Label="Rating" @bind-Value="rating" Step="1" />

<!-- ❌ Bad: Too granular steps -->
<BitNumberField Label="Age" @bind-Value="age" Step="0.01" />
```

### 4. Provide Clear Symbol Content
...
<!-- ❌ Bad: Confusing symbols -->
<BitNumberField Label="Quantity" @bind-Value="quantity">
    <SymbolContent>???</SymbolContent>
</BitNumberField>
```
